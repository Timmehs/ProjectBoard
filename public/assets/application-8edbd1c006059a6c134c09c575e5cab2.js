...
(function() { this.JST || (this.JST = {}); this.JST["projects/github_list_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\n<button data-id="',  project.id ,'"class="btn btn-default gh-project-btn">',  project.escape('name') ,'\n  <i class="fa fa-plus-circle"></i>\n</button>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["projects/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="project-index col-xs-8">\n\n</div>\n\n<div class="hacker-index-container col-xs-4">\n  <h3>Top Hackrz</h3>\n  <div class="hacker-index"></div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["projects/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h2>Add a project</h2>\n<div class="form-errors"></div>\n<div class="row">\n    <form class="form-horizontal new-form col-xs-8">\n      <div class="form-group">\n        <label for="project-title" class="col-sm-3 control-label">title</label>\n        <input type="hidden" id="project-title" name="project[name]">\n        <input type="hidden" id="project-uid" name="project[uid]">\n        <input type="hidden" id="project-ownerid" name="project[owner_id]" value=',  CURRENT_USER ,' >\n\n        <div class="col-sm-9">\n          <!-- TITLE -->\n          <span class="project-title"></span>\n        </div>\n      </div>\n\n      <!-- TAGS -->\n      <div class="form-group">\n        <label for="project-tags" class="col-sm-3 control-label">tags</label>\n        <div class="col-sm-9" style="padding-top: 7px">\n          <span class="project-tags"></span>\n        </div>\n      </div>\n\n      <div class="form-group">\n        <div class="col-sm-offset-3 col-sm-9">\n       \t <input type="hidden" id="project-tags" name="project[tag_list]" >\n        \t<input class="form-control" id="add-project-tags" placeholder="add project tags"></input>\n        </div>\n      </div>\n\n      <!-- DESCRIPTION -->\n      <div class="form-group">\n        <label for="project-desc" class="col-sm-3 control-label">description</label>\n        <div class="col-sm-9">\n          <textarea class="form-control" id="project-desc" name="project[description]" placeholder="Project Description"></textarea>\n        </div>\n      </div>\n\n      <!-- GITHUB URL -->\n      <div class="form-group">\n        <label for="project-github" class="col-sm-3 control-label">github</label>\n        <div class="col-sm-9">\n          <input type="text" class="form-control" id="project-github" name="project[html_url]">\n        </div>\n      </div>\n\n      <!-- WEBSITE -->\n      <div class="form-group">\n        <label for="project-homepage" class="col-sm-3 control-label">website</label>\n        <div class="col-sm-9">\n          <input type="text" class="form-control" id="project-homepage" name="project[homepage]">\n        </div>\n      </div>\n\n      <!-- SUBMIT -->\n      <div class=\'form-group\'>\n        <div class="col-sm-offset-3 col-sm-9">\n          <button type="submit" class="btn btn-primary">Add Project</a>\n          </div>\n        </div>\n  </form>\n\n\n  <div class="github-projects-container col-xs-4">\n    <h4>Github projects</h4>\n    <div class="github-list"></div>\n  </div> <!-- End GH Projects -->\n</div> <!-- End Row -->\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["projects/proj_list_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="row">\n  <div class="p title col-md-9">\n    <h3>',  project.escape('name') ,'</h3> <span class=\'score\'></span>\n    <button class="btn btn-default btn-xs star-btn">\n      <i class="fa fa-star"></i>\n    </button>\n  </div>\n  <div class="p author col-md-3">\n    <h4>\n      <span style="font-size: 14px">by</span>\n      <a href=\'',  project.authorGithub() ,'\' >',  project.authorName() ,'</a>\n    </h4>\n  </div>\n</div>\n<div class="row">\n  <div class="p tags col-md-12">\n    <ul>\n      ');  _(project.get('tags')).each(function(tag) { ; __p.push('\n      <li>',  tag ,'</li>\n      ');  }) ; __p.push('\n    </ul>\n  </div>\n</div>\n<div class="row">\n  <div class="p desc col-md-12">\n    <p>\n      ',  project.escape('description') ,'\n    </p>\n  </div>\n</div>\n<div class="row">\n  <div class="p col-md-12 btns">\n    <span class="buttons-left">\n      ');  if (project.get('homepage') == "") { project.set('homepage', project.get('html_url')); } ; __p.push('\n      <a target="_blank" href=\'',  project.get("homepage") ,'\'>website</a> |\n      <a target="_blank" href="',  project.get('html_url') ,'">github</a>\n    </span>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["users/hacker_view"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h3>',  user.get('username') ,'</h3>\n');}return __p.join('');};
}).call(this);
